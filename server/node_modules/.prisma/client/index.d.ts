...
export namespace Prisma {
  ...
  */
  ...
  export type AuthorSelect = {
    ...
    FirstName?: boolean
    LastName?: boolean
    books?: boolean | Author$booksArgs
  ...
  export class Prisma__AuthorClient<T, Null = never> implements PrismaPromise<T> {
    ...
    books<T extends Author$booksArgs= {}>(args?: Subset<T, Author$booksArgs>): PrismaPromise<Array<BookGetPayload<T>>| Null>;
  ...
  export type BookSelect = {
    ...
    Title?: boolean
    Description?: boolean
    authors?: boolean | Book$authorsArgs
  ...
  export class Prisma__BookClient<T, Null = never> implements PrismaPromise<T> {
    ...
    authors<T extends Book$authorsArgs= {}>(args?: Subset<T, Book$authorsArgs>): PrismaPromise<Array<AuthorGetPayload<T>>| Null>;
